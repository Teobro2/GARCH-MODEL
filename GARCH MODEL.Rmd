...
# Loop through components 2 to 12 and plot each one
for (i in 2:12) {
  plot(modelfit, which = i)
}
...
residualsdiag(GARCH_2)
residualsdiag(tGARCH)
residualsdiag(tGARCH_2)
residualsdiag(tGARCH_3)
residualsdiag(stGARCH)
residualsdiag(apARCH)
```
...
plotroll <- addSeries(sqrt(252)*sigma(tapARCH), col = "red", on = 1, lwd=2)
plotroll

plotroll <- addSeries(sqrt(252)*sigma(tGARCH), col = "green", on = 1, lwd=2)
plotroll
